...
NCountry = {
	...
	DEFAULT_STABILITY = 0.35,						-- Default stability if not scripted otherwise.
	DEFAULT_WAR_SUPPORT = 0.4,						-- Default war support if not scripted otherwise.
