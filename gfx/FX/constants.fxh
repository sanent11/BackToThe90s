...
// ------------------    HDR          	-------------------------
// --------------------------------------------------------------
static const float3 LUMINANCE_VECTOR  			= float3(0.1125f, 0.7154f, 0.0721f);
...
static const float3 FOG_COLOR 					= float3( 0.92, 0.98, 0.6 );
static const float 	FOG_BEGIN					= 1.0f;
static const float 	FOG_END 					= 950.0f;
static const float 	FOG_MAX 					= 0.95f; 
...
static const float GB_OPACITY_NEAR = 0.60f; // Transparency when camera is near
...
static const float BORDER_MAP_TILE = 12000.0f;
